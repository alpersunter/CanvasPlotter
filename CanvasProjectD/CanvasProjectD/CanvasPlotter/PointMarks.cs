using CanvasProjectD.CanvasPlotter.Markers;
 ...
 *  
 *  There will be a "IMarkerType" interface, which will supply enough flexibility and practicality for further marker types
 *  At this version, the only type implementing it is "Circle". (i.e. Currently, the only marker option is "Circle".)
 *  

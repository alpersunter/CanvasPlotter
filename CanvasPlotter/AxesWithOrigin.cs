...
/// <summary>
/// Following versions might store the Origin as Point instead of Tuple
/// </summary>
    ...
    public class AxesWithOrigin
    {
        ...
        public double XScalingFactor
        {
            ...
            set
            {
                ...
                if (value > 0)
                {
                    _XScalingFactor = value;
                }

            }
        }
        public bool XWontZoom { get; set; }
        ...
        public double YScalingFactor
        {
            ...
            set
            {
                if (value < 0)
                {
                    _YScalingFactor = value;
                }
            }
        }
        public bool YWontZoom { get; set; }
